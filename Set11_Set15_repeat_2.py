...
q2=q2[q2.Country.isin(country_list)]

q2=pd.pivot_table(q2, index='Country', values='Happiness_Score', columns='year')

q2['rate']=(q2[2017]-q2[2015])/2

q2.sort_values(by='rate').nlargest(3, 'rate')
